...
class PreencherAvaliacaoPage extends StatefulWidget {
  const PreencherAvaliacaoPage({super.key});

  @override
  State<PreencherAvaliacaoPage> createState() => _PreencherAvaliacaoPageState();
}

class _PreencherAvaliacaoPageState extends State<PreencherAvaliacaoPage> {
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Qual categoria do transporte está sendo avaliada?',
                filled: true,
                fillColor: Colors.grey[300],
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(8),
